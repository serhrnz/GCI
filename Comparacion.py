...
def ejecutar_comparacion(b):
    ...
    print(f"Se ha generado el archivo Excel con la tabla comparativa entre {pais} y {nombre_grupo}.Para descargarlo, revise la sección 'Archivos' a la izquierda de la pantalla y refresque la ventana. Luego, de clic en los tres puntos y luego en 'Descargar'.")
